...
var sum = multiply(bango3,bango4)
var  actual= divide(sum,bango5)
console.log(actual)
...
function eatFood(firstName, lastName, food){
  return fullName + " eats" + food + " every day for lunch."
}
console.log(eatFood("Richard"," Ribucan-Perales", " ramen"))
